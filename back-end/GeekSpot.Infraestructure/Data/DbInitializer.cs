...
namespace GeekSpot.Infraestructure.Data
{
    public static class DbInitializer
    {
        ...
        public static async Task Seed(Context context, DateTime dataAgora)
        {
            ...
            {
                await context.UsuariosInformacoes.AddAsync(new UsuarioInformacao() { UsuarioInformacaoId = 1, UsuarioId = 2, DataAniversario = dataAgora, CPF = "44571955880", Telefone = "12 98271-3939", CEP = 12605110, NumeroResidencia = "480", ReferenciaLocal = "Atrás da antiga fábrica G.A", DataUltimaAlteracao = null, LojinhaTitulo = "Lojinha Anheu", LojinhaDescricao = "Vendo tudo na metade do preço, só vem", LojinhaImagemCapa = "", LojinhaQtdEstrelas = null });
                ...
                await context.UsuariosInformacoes.AddAsync(new UsuarioInformacao() { UsuarioInformacaoId = 3, UsuarioId = 6, DataAniversario = dataAgora, CPF = "22222222222", Telefone = "12 99999-9998", CEP = 12604440, NumeroResidencia = "482", ReferenciaLocal = "", DataUltimaAlteracao = null, LojinhaTitulo = "Lojinha do Salerno", LojinhaDescricao = "Oi, né?", LojinhaImagemCapa = "", LojinhaQtdEstrelas = null });
            }
