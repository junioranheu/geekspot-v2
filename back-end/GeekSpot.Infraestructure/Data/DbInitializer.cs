    ...
    public static class DbInitializer
    {
        ...
        public static async Task Seed(Context context, DateTime dataAgora)
        {
            ...
            if (!await context.UsuariosInformacoes.AnyAsync())
            {
                ...
                await context.UsuariosInformacoes.AddAsync(new UsuarioInformacao() { UsuarioInformacaoId = 2, UsuarioId = 5, DataAniversario = dataAgora, CPF = "11111111111", Telefone = "12 99999-9999", CEP = "12606150", Estado = "SP", Cidade = "Lorena", Bairro = "Vila Passos", Rua = "Rua das Toranjas", NumeroResidencia = "481", ReferenciaLocal = "", DataUltimaAlteracao = null, LojinhaTitulo = "Lojinha do Chalequito", LojinhaDescricao = "Toy pal hoyo po weon", LojinhaImagemCapa = "", LojinhaQtdEstrelas = null });
                await context.UsuariosInformacoes.AddAsync(new UsuarioInformacao() { UsuarioInformacaoId = 3, UsuarioId = 6, DataAniversario = dataAgora, CPF = "22222222222", Telefone = "12 99999-9998", CEP = "12604440", Estado = "SP", Cidade = "Lorena", Bairro = "Vila Passos", Rua = "Rua das Maçãs", NumeroResidencia = "482", ReferenciaLocal = "", DataUltimaAlteracao = null, LojinhaTitulo = "Lojinha do Salerno", LojinhaDescricao = "Oi, né?", LojinhaImagemCapa = "", LojinhaQtdEstrelas = null });
            }
            ...
            if (!await context.Itens.AnyAsync())
            {
                ...
                await context.Itens.AddAsync(new Item() { ItemId = 7, Nome = "iPhone", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Apple", Condicao = nameof(CondicaoEnum.Excelente), Preco = 2000, PrecoDesconto = null, UsuarioId = 5, ItemTipoId = 15, IsAtivo = true, DataRegistro = dataAgora });
                await context.Itens.AddAsync(new Item() { ItemId = 8, Nome = "Violão acústico (baby)", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Shelby", Condicao = nameof(CondicaoEnum.Excelente), Preco = 1200, PrecoDesconto = null, UsuarioId = 5, ItemTipoId = 14, IsAtivo = true, DataRegistro = dataAgora });
                await context.Itens.AddAsync(new Item() { ItemId = 9, Nome = "Headset pro", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Razer", Condicao = nameof(CondicaoEnum.Excelente), Preco = 500, PrecoDesconto = 350, UsuarioId = 5, ItemTipoId = 2, IsAtivo = true, DataRegistro = dataAgora });
                await context.Itens.AddAsync(new Item() { ItemId = 10, Nome = "Nintendo Switch V2", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Nintendo", Condicao = nameof(CondicaoEnum.Novo), Preco = 1700, PrecoDesconto = 1350.99, UsuarioId = 5, ItemTipoId = 6, IsAtivo = true, DataRegistro = dataAgora });
                await context.Itens.AddAsync(new Item() { ItemId = 11, Nome = "PS4", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Sony", Condicao = nameof(CondicaoEnum.Usado), Preco = 3500, PrecoDesconto = null, UsuarioId = 5, ItemTipoId = 6, IsAtivo = true, DataRegistro = dataAgora });
                await context.Itens.AddAsync(new Item() { ItemId = 12, Nome = "Guatona Kla", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Submundo dos deuses", Condicao = nameof(CondicaoEnum.Disfuncional), Preco = 10000, PrecoDesconto = 9999.99, UsuarioId = 5, ItemTipoId = 1, IsAtivo = true, DataRegistro = dataAgora });

                // Itens do usuário @ateu (6);
                await context.Itens.AddAsync(new Item() { ItemId = 13, Nome = "Guitarra dos sonhos", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Shelter Nashville", Condicao = nameof(CondicaoEnum.Disfuncional), Preco = 3000, PrecoDesconto = null, UsuarioId = 6, ItemTipoId = 14, IsAtivo = true, DataRegistro = dataAgora });
                await context.Itens.AddAsync(new Item() { ItemId = 14, Nome = "Nike zika", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = "44", Marca = "Nike", Condicao = nameof(CondicaoEnum.Excelente), Preco = 890, PrecoDesconto = null, UsuarioId = 6, ItemTipoId = 12, IsAtivo = true, DataRegistro = dataAgora });
                await context.Itens.AddAsync(new Item() { ItemId = 15, Nome = "Palheta da Fender", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Fender", Condicao = nameof(CondicaoEnum.Excelente), Preco = 1, PrecoDesconto = 0.99, UsuarioId = 6, ItemTipoId = 14, IsAtivo = true, DataRegistro = dataAgora });
                await context.Itens.AddAsync(new Item() { ItemId = 16, Nome = "Apple Watch", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Apple", Condicao = nameof(CondicaoEnum.Excelente), Preco = 1500, PrecoDesconto = null, UsuarioId = 6, ItemTipoId = 16, IsAtivo = true, DataRegistro = dataAgora });
                await context.Itens.AddAsync(new Item() { ItemId = 17, Nome = "The Dark Side Of The Moon", Descricao = LoremIpsum(10, 40, 1, 3, 1, false), Tamanho = null, Marca = "Pink Floyd", Condicao = nameof(CondicaoEnum.Excelente), Preco = 370.99, PrecoDesconto = null, UsuarioId = 6, ItemTipoId = 13, IsAtivo = true, DataRegistro = dataAgora });
            }
            ...
            {
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 1, AjudaTopicoId = 1, Titulo = "O GeekSpot", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 2, AjudaTopicoId = 1, Titulo = "O GeekSpot Pro", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 3, AjudaTopicoId = 1, Titulo = "Política de privacidade e termos de uso do GeekSpot", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 4, AjudaTopicoId = 1, Titulo = "Horário de atendimento", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 5, AjudaTopicoId = 1, Titulo = "Segurança", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });

                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 6, AjudaTopicoId = 2, Titulo = "Como participar do GeekSpot Pro", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 7, AjudaTopicoId = 2, Titulo = "Quais as vantagens?", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 8, AjudaTopicoId = 2, Titulo = "Quero alterar meu anúncio", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 9, AjudaTopicoId = 2, Titulo = "Descontos e taxas", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 10, AjudaTopicoId = 2, Titulo = "Quero sair do GeekSpot Pro", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 11, AjudaTopicoId = 2, Titulo = "Quanto tempo meus itens ficam no modo Pro?", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });

                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 12, AjudaTopicoId = 3, Titulo = "Contato com o geek que está trocando comigo", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 13, AjudaTopicoId = 3, Titulo = "Entregas e prazos", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 14, AjudaTopicoId = 3, Titulo = "Serviço de proteção", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 15, AjudaTopicoId = 3, Titulo = "Cancelamento", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 16, AjudaTopicoId = 3, Titulo = "Devolução e reembolso", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 17, AjudaTopicoId = 3, Titulo = "Denunciar ou reportar abusos", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });

                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 18, AjudaTopicoId = 4, Titulo = "Contato com o geek ou loja que está vendendo para mim", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 19, AjudaTopicoId = 4, Titulo = "Entregas e prazos", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 20, AjudaTopicoId = 4, Titulo = "Serviço de proteção", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 21, AjudaTopicoId = 4, Titulo = "Cancelamento", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 22, AjudaTopicoId = 4, Titulo = "Devolução e reembolso", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 23, AjudaTopicoId = 4, Titulo = "Denunciar ou reportar abusos", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });

                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 24, AjudaTopicoId = 5, Titulo = "Contato com o geek para quem estou vendenmdo", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 25, AjudaTopicoId = 5, Titulo = "Entregas e prazos", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 26, AjudaTopicoId = 5, Titulo = "Serviço de proteção", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 27, AjudaTopicoId = 5, Titulo = "Cancelamento", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 28, AjudaTopicoId = 5, Titulo = "Devolução e reembolso", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 29, AjudaTopicoId = 5, Titulo = "Denunciar ou reportar abusos", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });

                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 30, AjudaTopicoId = 6, Titulo = "Criar uma conta", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 31, AjudaTopicoId = 6, Titulo = "Editar meus dados", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 32, AjudaTopicoId = 6, Titulo = "E-mail", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 33, AjudaTopicoId = 6, Titulo = "Notificações", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 34, AjudaTopicoId = 6, Titulo = "Desativar ou reativar meus itens", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 35, AjudaTopicoId = 6, Titulo = "Excluir minha conta", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 36, AjudaTopicoId = 6, Titulo = "Lei geral de proteção de dados (LGPD)", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });

                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 37, AjudaTopicoId = 7, Titulo = "Identificando uma página falsa", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 38, AjudaTopicoId = 7, Titulo = "Transação de dados", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 39, AjudaTopicoId = 7, Titulo = "Fraudes: como posso evitar?", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 40, AjudaTopicoId = 7, Titulo = "Como aumentar a segurança na minha transação?", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
                await context.AjudasItens.AddAsync(new AjudaItem() { AjudaItemId = 41, AjudaTopicoId = 7, Titulo = "Lei geral de proteção de dados (LGPD)", ConteudoHtml = "xxx", DataRegistro = dataAgora, IsAtivo = true });
            }
            #endregion
