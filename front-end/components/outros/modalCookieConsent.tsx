    ...
    return (
        ...
        >
            <div style={{ marginBottom: '12px' }}>
                <span>A sua privacidade é importante para nós. É política do <b className='cor-principal'>GeekSpot</b> respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar na plataforma.</span>
                <br />
