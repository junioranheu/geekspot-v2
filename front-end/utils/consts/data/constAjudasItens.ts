...
const ENDPOINTS = {
    GET_TODOS: 'api/AjudasItens/todos',
    GET_BY_ID: 'api/AjudasItens',
    POST_ADICIONAR: 'api/AjudasItens/adicionar',
    PUT_ATUALIZAR: 'api/AjudasItens/atualizar',
    DELETE_DELETAR: 'api/AjudasItens/deletar',
    GET_BY_AJUDA_TOPICO_ID: 'api/AjudasItens/byAjudaTopicoId',
    GET_BY_QUERY: 'api/AjudasItens/byQuery' 
};
...
const DEV = {
    ...
    API_URL_GET_BY_AJUDA_TOPICO_ID: `${API_BASE_URL_DEV}/${ENDPOINTS.GET_BY_AJUDA_TOPICO_ID}`,
    API_URL_GET_BY_QUERY: `${API_BASE_URL_DEV}/${ENDPOINTS.GET_BY_QUERY}`
};
...
const PROD = {
    ...
    API_URL_GET_BY_AJUDA_TOPICO_ID: `${API_BASE_URL_PROD}/${ENDPOINTS.GET_BY_AJUDA_TOPICO_ID}`,
    API_URL_GET_BY_QUERY: `${API_BASE_URL_PROD}/${ENDPOINTS.GET_BY_QUERY}`
};
