...
const ENDPOINTS = {
    ...
    GET_BY_ID: 'api/Comentarios',
    POST_ADICIONAR: 'api/Comentarios/adicionar',
    PUT_ATUALIZAR: 'api/Comentarios/atualizar',
    DELETE_DELETAR: 'api/Comentarios/deletar',
    GET_BY_ITEM_ID: 'api/Comentarios/byItemId',
...
const DEV = {
    ...
    API_URL_GET_BY_ITEM_ID: `${API_BASE_URL_DEV}/${ENDPOINTS.GET_BY_ITEM_ID}`,
...
const PROD = {
    ...
    API_URL_GET_BY_ITEM_ID: `${API_BASE_URL_PROD}/${ENDPOINTS.GET_BY_ITEM_ID}`,
